...
(value: prismicT.PrismicDocumentWithUID): true => {
	switch (typeof value) {
		case "object": {
			if (value === null) {
				expectNever(value);
...
expectType<prismicT.PrismicDocumentWithUID>({
	id: "string",
	uid: "string",
	url: "string",
	type: "string",
 ...
 */
expectType<prismicT.PrismicDocumentWithUID<{ foo: prismicT.BooleanField }>>({
	id: "string",
	uid: "string",
	url: "string",
	type: "string",
